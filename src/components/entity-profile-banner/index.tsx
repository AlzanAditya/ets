...
> = {
  emerald: {
    outerBorder: "from-emerald-400/60 via-[var(--banner-border-via)] to-emerald-400/60",
    shadow: "shadow-[0_4px_24px_rgba(16,185,129,0.08)]",
    innerBg: "from-emerald-500/10 via-[var(--banner-bg-via)] to-[var(--banner-bg-to)]",
    detailIconBg: "bg-emerald-500/10 text-emerald-600 dark:text-emerald-400",
    detailHoverBorder: "hover:border-emerald-500/40",
  },
  white: {
    outerBorder: "from-zinc-300/80 via-[var(--banner-border-via)] to-zinc-300/80 dark:from-zinc-600/70 dark:to-zinc-600/70",
    shadow: "shadow-[0_4px_24px_rgba(0,0,0,0.06)]",
    innerBg: "from-zinc-100/90 via-[var(--banner-bg-via)] to-[var(--banner-bg-to)]",
    detailIconBg: "bg-zinc-500/10 text-zinc-700 dark:text-zinc-300",
    detailHoverBorder: "hover:border-zinc-400/50",
  },
  red: {
    outerBorder: "from-red-500/70 via-[var(--banner-border-via)] to-red-500/70",
    shadow: "shadow-[0_4px_24px_rgba(239,68,68,0.12)]",
    innerBg: "from-red-500/10 via-[var(--banner-bg-via)] to-[var(--banner-bg-to)]",
    detailIconBg: "bg-red-500/10 text-red-600 dark:text-red-400",
    detailHoverBorder: "hover:border-red-500/50",
  },
  amber: {
    outerBorder: "from-amber-400/60 via-[var(--banner-border-via)] to-amber-400/60",
    shadow: "shadow-[0_4px_24px_rgba(245,158,11,0.08)]",
    innerBg: "from-amber-500/10 via-[var(--banner-bg-via)] to-[var(--banner-bg-to)]",
    detailIconBg: "bg-amber-500/10 text-amber-600 dark:text-amber-400",
    detailHoverBorder: "hover:border-amber-500/40",
  },
  orange: {
    outerBorder: "from-orange-400/60 via-[var(--banner-border-via)] to-orange-400/60",
    shadow: "shadow-[0_4px_24px_rgba(249,115,22,0.08)]",
    innerBg: "from-orange-500/10 via-[var(--banner-bg-via)] to-[var(--banner-bg-to)]",
    detailIconBg: "bg-orange-500/10 text-orange-600 dark:text-orange-400",
    detailHoverBorder: "hover:border-orange-500/40",
  },
  blue: {
    outerBorder: "from-blue-400/60 via-[var(--banner-border-via)] to-blue-400/60",
    shadow: "shadow-[0_4px_24px_rgba(59,130,246,0.08)]",
    innerBg: "from-blue-500/10 via-[var(--banner-bg-via)] to-[var(--banner-bg-to)]",
    detailIconBg: "bg-blue-500/10 text-blue-600 dark:text-blue-400",
    detailHoverBorder: "hover:border-blue-500/40",
  },
  rose: {
    outerBorder: "from-rose-400/60 via-[var(--banner-border-via)] to-rose-400/60",
    shadow: "shadow-[0_4px_24px_rgba(244,63,94,0.08)]",
    innerBg: "from-rose-500/10 via-[var(--banner-bg-via)] to-[var(--banner-bg-to)]",
    detailIconBg: "bg-rose-500/10 text-rose-600 dark:text-rose-400",
    detailHoverBorder: "hover:border-rose-500/40",
  },
  purple: {
    outerBorder: "from-purple-400/60 via-[var(--banner-border-via)] to-purple-400/60",
    shadow: "shadow-[0_4px_24px_rgba(168,85,247,0.08)]",
    innerBg: "from-purple-500/10 via-[var(--banner-bg-via)] to-[var(--banner-bg-to)]",
    detailIconBg: "bg-purple-500/10 text-purple-600 dark:text-purple-400",
    detailHoverBorder: "hover:border-purple-500/40",
  },
  indigo: {
    outerBorder: "from-indigo-400/60 via-[var(--banner-border-via)] to-indigo-400/60",
    shadow: "shadow-[0_4px_24px_rgba(99,102,241,0.08)]",
    innerBg: "from-indigo-500/10 via-[var(--banner-bg-via)] to-[var(--banner-bg-to)]",
    detailIconBg: "bg-indigo-500/10 text-indigo-600 dark:text-indigo-400",
    detailHoverBorder: "hover:border-indigo-500/40",
  },
  slate: {
    outerBorder: "from-slate-400/60 via-[var(--banner-border-via)] to-slate-400/60",
    shadow: "shadow-[0_4px_24px_rgba(100,116,139,0.08)]",
    innerBg: "from-slate-500/10 via-[var(--banner-bg-via)] to-[var(--banner-bg-to)]",
